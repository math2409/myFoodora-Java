...
public class SetPhoneCommand implements Command {
	private Core core;

	/**
	 * @param core
	 */
	public SetPhoneCommand(Core core) {
		super();
		this.core = core;
	}
	...
	public void execute(String[] args) {
		...
		core.setPhone(args[0]);
		System.out.println("Successfully set the phone number to "+ args[0]);
	}
