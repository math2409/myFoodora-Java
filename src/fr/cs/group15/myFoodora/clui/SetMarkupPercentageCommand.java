...
public class SetMarkupPercentageCommand implements Command {
	private Core core;

	/**
	 * @param core
	 */
	public SetMarkupPercentageCommand(Core core) {
		super();
		this.core = core;
	}
	...
	public void execute(String[] args) {
		...
		core.setMarkupPercentage(Double.parseDouble(args[0]));
	}
